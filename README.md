...
Ci-dessous, la liste des fonctionnalités livrées par user story implémentés lors de ces différents sprints :
...
Prévenir le client qu'un panier est disponlible (partie de Too Good To Go) #28 :
